...
@endif
        ...
        <div class="col-md-12">
            <div class="card">
                ...
                <div class="card-body">
                    <form method="post" action="{{ '/admin/success-story/store' }}" enctype="multipart/form-data">
                        @csrf
                                ...
                                <div class="col-md-6 mt-3">
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" id="ss_name" name="ss_name"
                                            value="{{ old('ss_name') }}" placeholder="eg. Bride Name & Groom Name" required>
                                    </div>
                                </div>
                                <div class="col-md-6 mt-3">
                                    <div class="form-group">
                                        <label for="ss_location">Short Message</label>
                                        <input type="text" class="form-control" id="ss_location"
                                            value="{{ old('ss_location') }}" name="ss_location" placeholder="Enter Short Message"
                                            required>
                                    </div>
                                </div>
