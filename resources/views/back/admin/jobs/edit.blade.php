...
@section('content')
    ...
    <body class="hold-transition sidebar-mini layout-fixed">
        <div class="wrapper">
            <div class="content-wrapper">
                ...
                <section class="content">
                    <form action="/admin/job/update/{{ $data->job_id }}" method="post">
                        @csrf
                        <div class="container-fluid">
                            <div class="row">
                                <div class="col-12">
                                    ...
                                    <div class="card">
                                        <div class="card-header text-right">
                                            <h3 class="card-title mt-1">Admin Edit Job</h3>
                                            <a href="/admin/jobs/list" class="btn btn-success">View Jobs List</a>
                                        </div>
                                            ...
                                            <div class="container">
                                                <div class="row">
                                                            ...
                                                            <div class="input-group">
                                                                <select name="company_id" id="companiesName"
                                                                    ...
                                                                    @foreach ($companiesName as $item)
                                                                        @if ($data->job_company_id == $item->company_name_id)
                                                    ...
                                                    <div class="col-sm-4 mt-3">
                                                        ...
                                                        <div class="form-group">
                                                            <div class="input-group">
                                                                <select name="job_title" id="jobTitles"
                                                                    class="form-control">
                                                                    @foreach ($jobTitles as $item)
                                                                        @if ($data->job_job_title_id == $item->job_title_id)
                                                ...
                                                <div class="row">
                                                            ...
                                                            <div class="input-group">
                                                                <select name="location_id" id="locations"
                                                                    ...
                                                                    @foreach ($locations as $item)
                                                                        @if ($data->job_location_id == $item->location_id)
                                                            ...
                                                            <div class="input-group">
                                                                <select name="experience_id" id="experiences"
                                                                    ...
                                                                    @foreach ($experiences as $item)
                                                                        @if ($data->job_experience_id == $item->experiences_id)
                                                        ...
                                                        <div class="form-group">
                                                            <div class="input-group">
                                                                <select class="select2" multiple="multiple"
                                                                    name="skill_id[]" id="skills__id"
                                                                    data-placeholder="Select Skills" style="width: 100%;">
                                                    ...
                                                    <div class="col-sm-3 mt-3">
                                                        ...
                                                        <div class="form-group">
                                                            <select class="form-control" name="job_type__"
                                                                id="job_type">
                                                                @foreach ($jobType as $item)
                                                                    @if ($data->job_type == $item->job_type_id)
                                                                        <option value="{{ $item->job_type_id }}" selected>
                                                                            {{ $item->job_type_name }}
                                                                        </option>
                                                                    @else
                                                    ...
                                                    <div class="col-sm-12 mt-3">
                                                        ...
                                                        <textarea id="summernote" name="job_description">{{ $data->job_description }}</textarea>
                                                    </div>
                                                </div>
                                            </div>
                                            <!-- /.row -->
                                        ...
                                        <div class="text-center mb-3">
                                            <button type="submit" class="btn btn-success">Update Job
                                            </button>
                                        </div>
                    </form>
                </section>
        ...
        <script>
            window.onload = () => {
                $("#skills__id").val({{ json_encode(array_map('intval', $job_skills_id)) }}).trigger('change');
                $("#education__").val({{ json_encode(array_map('intval', $job_education_id)) }}).trigger('change');
            }
