        ...
        <div class="wrapper">
            <div class="content-wrapper">
                ...
                <section class="content">
                    <form action="/admin/settings/job-titles/update" method="post">
                        @csrf
                                ...
                                <div class="col-12">
                                    ...
                                    <div class="card">
                                        <div class="card-header text-right">
                                            <h3 class="card-title mt-1">Job Title Update</h3>
        ...
        <script>
            window.onload = () => {
                @if ($categoriesArray !== null)
                    $("#job_categoires_id").val({{ json_encode(array_map('intval', $categoriesArray)) }}).trigger('change');
                @endif
            }
        </script>
    </body>
