...
@section('title')
    Update Candidate Profile| istepup job-Portal
@endsection
@section('content')
                        ...
                        <div class="col-md-12">
                            ...
                            <div class="card ">
                                ...
                                <div class="card-header text-right">
                                    ...
                                    <!-- <a href="/dashboard/admin/candidate" class="btn btn-info mx-3"><i class="fa fa-eye"
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-lg-4">
                                                ...
                                                <div class="input-group mb-3">
                                                    ...
                                                    <input type="text" class="form-control" placeholder="  First Name"
                                                        name="fname" value="{{ $candidate->fname }}">
                                                </div>
                                                @if ($errors->has('fname'))
                                            ...
                                            <div class="col-lg-4">
                                                ...
                                                <div class="input-group mb-3">
                                                    ...
                                                    <input type="text" class="form-control" placeholder="  Middle Name"
                                                        name="mname" value="{{ $candidate->mname }}">
                                                </div>
                                                @if ($errors->has('mname'))
                                            ...
                                            <div class="col-lg-4">
                                                ...
                                                <div class="input-group mb-3">
                                                    ...
                                                    <input type="text" class="form-control" placeholder="  Last Name"
                                                        name="lname" value="{{ $candidate->lname }}">
                                                </div>
                                                @if ($errors->has('lname'))
                                            ...
                                            <div class="col-md-4">
                                                ...
                                                <div class="input-group mb-3">
                                                    ...
                                                    <input type="number" class="form-control" placeholder="phone"
                                                        name="phone" value="{{ $candidate->phone }}">
                                                </div>
                                                @if ($errors->has('phone'))
                                            ...
                                            <div class="col-md-4">
                                                ...
                                                <div class="input-group mb-3">
                                                    ...
                                                    <input type="number" class="form-control" placeholder="mobile"
                                                        name="mobileno" value="{{ $candidate->mobile }}">
                                                </div>
                                            ...
                                            <div class="col-md-4">
                                                ...
                                                <div class="input-group mb-3">
                                                    ...
                                                    <input type="date" class="form-control" placeholder="mobile"
                                                        name="bdate" value="{{ $candidate->bdate }}">
                                                </div>
                                                @if ($errors->has('bdate'))
                                            ...
                                            <div class="col-md-4">
                                                ...
                                                <div class="input-group mb-3">
                                                    ...
                                                    <select class="form-control" id="gender" name="gender">
                                                        <option value="{{ $candidate->gender }}" selected="selected">
                                                            {{ $candidate->gender }}
                                                        </option>
                                            ...
                                            <div class="col-md-4">
                                                ...
                                                <div class="input-group mb-3">
                                                    ...
                                                    <select class="form-control" id="mstatus" name="mstatus">
                                                        <option value="{{ $candidate->mstatus }}" selected="selected">
                                                            {{ $candidate->mstatus }}
                                                        </option>
                                            ...
                                            <div class="col-md-12">
                                                ...
                                                <div class="input-group mb-3">
                                                    ...
                                                    <select class="form-control" id="nationality" name="nationality">
                                                        <option value="{{ $candidate->nationality }}" selected="selected">
                                            ...
                                            <div class="col-md-12">
                                                ...
                                                <div class="input-group mb-3">
                                                    ...
                                                    <textarea name="streetaddress" class="form-control" rows="3"
                                                        placeholder="Enter ..." value="{{ $candidate->address}}"> {{ $candidate->address }} </textarea>
                                                </div>
                                            ...
                                            <div class="col-md-4">
                                                ...
                                                <div class="input-group mb-3">
                                                    ...
                                                    <select class="form-control" id="country_id" name="country">
                                                        <option value="{{ $candidate->country }}" selected="selected">
                                                            {{ $candidate->country }}
                                                        </option>
                                            ...
                                            <div class="col-md-4">
                                                ...
                                                <div class="input-group mb-3">
                                                    ...
                                                    <select name="state" id="state" class="form-control">
                                                        <option value="{{ $candidate->state }}" selected="selected">
                                                            {{ $candidate->state }}
                                                        </option>
                                            ...
                                            <div class="col-md-4">
                                                ...
                                                <div class="input-group mb-3">
                                                    ...
                                                    <input type="text" name="city" value="{{ $candidate->city }}" id=""
                                                        class="form-control">
                                                </div>
                                                @if ($errors->has('city'))
                                            ...
                                            <div class="col-md-6">
                                                ...
                                                <div class="input-group mb-3">
                                                    ...
                                                    <select class="form-control" id="industry_id" name="industry">
                                                        <option value="{{ $candidate->industry }}" selected="selected">
                                                            {{ $candidate->industry }}
                                                        </option>
                                            ...
                                            <div class="col-md-6">
                                                ...
                                                <div class="input-group mb-3">
                                                    ...
                                                    <select class="form-control" id="no_of_offices" name="careerlevel">
                                                        <option value="{{ $candidate->clevel }}" selected="selected">
                                                            {{ $candidate->clevel }}
                                                        </option>
                                                ...
                                                @if ($errors->has('clevel'))
                                                    <span
                                                        class="text-danger">{{ $errors->first('clevel') }}</span>
                                                @endif
                                            </div>
                                            ...
                                            <div class="col-md-4">
                                                ...
                                                <div class="input-group mb-3">
                                                    ...
                                                    <select class="form-control" id="functional_area_id" name="farea">
                                                        <option value="{{ $candidate->farea }}" selected="selected">
                                                            {{ $candidate->farea }}
                                                        </option>
                                            ...
                                            <div class="col-12 mb-3">
                                                ...
                                                <div class="input-group mb-3">
                                                    ...
                                                    <select class="form-control" id="job_experience_id"
                                                        name="experience">
                                                        <option value="{{ $candidate->jobexp }}" selected="selected">
                                                            {{ $candidate->jobexp }}</option>
                                            ...
                                            <div class="col-md-4">
                                                ...
                                                <div class="input-group mb-3">
                                                    ...
                                                    <input type="url" class="form-control" placeholder="linkedin"
                                                        name="linkin" value="{{ $candidate->linkedin }}">
                                                </div>
                                            ...
                                            <div class="col-md-4">
                                                ...
                                                <div class="input-group mb-3">
                                                    ...
                                                    <input type="url" class="form-control" placeholder="Google +"
                                                        name="google" value="{{ $candidate->google }}">
                                                </div>
                                            ...
                                            <div class="form-group col-sm-12">
                                                ...
                                                <div class="mb-3">
                                                    <input class="form-control" value="{{ $candidate->resume }}" type="file"
