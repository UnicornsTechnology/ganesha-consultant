        ...
        <div class="menu-topbar-area">
            ...
            <div class="menu-area">
                <div class="header-logo">
                    <a href="/"><img alt="image" class="img-fluid" src="{{ asset('logo.png') }}" width="200px" height="80px"></a>
                </div>
                <div class="main-menu">
                ...
                <div class="content">
                    ...
                    <span><img src="{{ asset('front_assets/images/icon/clock-1.svg') }}" alt> 10 min ago</span>
                </div>
                </li>
                <li>
                    <div class="icon">
                        <img src="{{ asset('front_assets/images/bg/company-logo/notifacion-2.png') }}" alt>
                    </div>
                    <div class="content">
                        <h6><a href="#">Your application has accepted in 5 vacancies.</a>
                        </h6>
                ...
                <li>
                    <div class="icon">
                        <img src="{{ asset('front_assets/images/bg/company-logo/notifacion-3.png') }}" alt>
                    </div>
                    <div class="content">
                        <h6><a href="#">Your application has accepted in 5 vacancies.</a>
                        </h6>
                    ...
                    <div class="col-lg-6 d-flex justify-content-lg-end justify-content-center">
                        <div class="footer-btm-menu">
                            <ul>
                                ...
                                <li><a href="https://www.google.com/maps/place/Egens+Lab/@23.8340712,90.3634979,17z/data=!3m1!4b1!4m5!3m4!1s0x3755c14c8682a473:0xa6c74743d52adb88!8m2!3d23.8340663!4d90.3656866">Our
                                        Sitemap</a></li>
                            </ul>
                        </div>
                    </div>
                ...
                <div class="row border-top align-items-center">
                    <div class="col-lg-6 d-flex  justify-content-lg-start justify-content-center">
                        <div class="copyright-area">
                            <p>©Copyright 2023 <a href="#">HireTop</a> | Design By <a href="https://ajspire.com/" target="_blank">Ajspire Technologies Pvt. Ltd.</a></p>
                        </div>
                    </div>
                    <div class="col-lg-6 d-flex justify-content-lg-end justify-content-center">
                        <div class="social-area">
