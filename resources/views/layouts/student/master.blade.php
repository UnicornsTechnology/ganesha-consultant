...
<body class="bg-wight" style="background: #f8f8f8 !important">
    <div class="eg-preloder">
    </div>

    <header class="header-area style-1">
        <div class="header-main-logo d-lg-block d-none">
            <a href="/"><img alt="image" src="{{ asset('logo.png') }}" width="200px" height="70px"></a>
        </div>
                        ...
                        @else
                            <li class="d-md-flex d-none">
                                <div class="post-job-btn">
                                    <a class="primry-btn-2 lg-btn" href="job-post.html">Sign Up
                                        <svg width="15" height="13" viewbox="0 0 15 13"
                                            xmlns="http://www.w3.org/2000/svg">
                                            <path
                                                d="M10.1367 0H4.86329C4.66914 0 4.51173 0.151188 4.51173 0.337662V1.79366H1.43168C0.642247 1.79363 0 2.41049 0 3.16868V11.6249C0 12.3831 0.642247 13 1.43168 13H13.5683C14.3578 13 15 12.3831 15 11.6249V3.16868C15 2.41049 14.3578 1.79363 13.5683 1.79363H10.4883V0.337662C10.4883 0.15116 10.3309 0 10.1367 0ZM5.21485 0.675325H9.78518V1.79366H5.21485V0.675325ZM13.5683 12.3247H1.43168C1.02996 12.3247 0.703126 12.0108 0.703126 11.625V5.31469L5.6836 7.11899V8.14608C5.6836 8.33255 5.84102 8.48374 6.03517 8.48374H8.96486C9.15901 8.48374 9.31642 8.33255 9.31642 8.14608V7.11899L14.2969 5.31472V11.625C14.2969 12.0108 13.9701 12.3247 13.5683 12.3247ZM6.38673 7.80841V6.79543H8.6133V7.80841H6.38673ZM14.2969 3.16868V4.59294L9.3108 6.39926C9.28191 6.24073 9.13821 6.1201 8.96486 6.1201H6.03517C5.86182 6.1201 5.71812 6.2407 5.68923 6.39926L0.703126 4.59297V3.16868C0.703126 2.78284 1.02993 2.46896 1.43168 2.46896H13.5683C13.9701 2.46896 14.2969 2.78284 14.2969 3.16868ZM13.4071 11.0443C13.4071 11.2308 13.2497 11.382 13.0555 11.382H10.1697C9.97558 11.382 9.81816 11.2308 9.81816 11.0443C9.81816 10.8578 9.97558 10.7067 10.1697 10.7067H13.0555C13.2497 10.7067 13.4071 10.8578 13.4071 11.0443ZM1.89337 3.67202C1.89337 3.48555 2.05079 3.33436 2.24494 3.33436H4.09064C4.28479 3.33436 4.44221 3.48555 4.44221 3.67202C4.44221 3.8585 4.28479 4.00968 4.09064 4.00968H2.24494C2.05079 4.00968 1.89337 3.8585 1.89337 3.67202Z" />
    ...
    <div class="dashboard-area pt-3 mb-120">
        <div class="container">
                                ...
                                <ul>
                                    ...
                                    <li>
                                        <a href="/student/profile"
                                            class="{{ Request::is('student/profile') ? 'active' : '' }}">
                                            <svg width="18" height="18" viewbox="0 0 18 18"
                                                xmlns="http://www.w3.org/2000/svg">
                                                <path
                                    ...
                                    <li>
                                        <a href="/student/applied-jobs"
                                            class="{{ Request::is('student/applied-jobs') ? 'active' : '' }}">
                                    ...
                                    {{-- <li>
                                        <a href="/student/package"
                                            class="{{ Request::is('student/package') ? 'active' : '' }}">
                                            <svg width="16" height="18" viewbox="0 0 16 18"
                                                xmlns="http://www.w3.org/2000/svg">
                                                <path
                                    ...
                                    <li>
                                        <a href="/student/bookmarks"
                                            class="{{ Request::is('student/bookmarks') ? 'active' : '' }}">
                                            <svg width="16" height="18" viewbox="0 0 16 18"
                                                xmlns="http://www.w3.org/2000/svg">
                                                <path
                                                    d="M13.82 1.24621H13.534V0.368701C13.534 0.165086 13.374 0 13.1767 0H8.00178C7.80442 0 7.6444 0.165086 7.6444 0.368701V1.24621H2.18003C1.10788 1.24621 0 1.83613 0 3.49529V15.7509C0 17.4101 1.12575 18 2.18003 18H13.82C14.8921 18 16 17.4101 16 15.7509V3.49898C16.0036 2.41131 15.4282 1.24621 13.82 1.24621ZM8.35916 0.737403H12.8193V7.20811L10.8179 5.47522C10.6848 5.3593 10.49 5.3593 10.3569 5.47522L8.35559 7.20811L8.35916 0.737403ZM13.8235 17.2626H2.18003C1.63323 17.2626 0.714764 17.0672 0.714764 15.7509V3.49898C0.714764 2.18271 1.63323 1.9873 2.18003 1.9873H7.6444V8.00819C7.64408 8.21181 7.80383 8.37717 8.0012 8.37749C8.08496 8.37763 8.16613 8.3474 8.2305 8.29209L10.5892 6.25317L12.9479 8.29209C13.0996 8.42243 13.3249 8.40123 13.4513 8.24476C13.5049 8.17835 13.5342 8.09461 13.534 8.00819V1.98361H13.82C15.0958 1.98361 15.2852 2.93118 15.2852 3.49529L15.2888 15.7509C15.2888 17.0672 14.3703 17.2626 13.8235 17.2626Z" />
                            ...
                            <ul class="recent-activitys">
                                <li>
                                    <div class="company-img">
                                        <img src="assets/images/bg/company-logo/recent-activity-01.png" alt>
                                    </div>
                                    <div class="content">
                                        <h6><a href="blog-details.html">Your application has accepted in 2
                                                vacancies.</a></h6>
                                        <span><img src="assets/images/icon/clock-1.svg" alt> 7 hour ago</span>
                                    </div>
                                </li>
                                <li>
                                    <div class="company-img">
                                        <img src="assets/images/bg/company-logo/recent-activity-02.png" alt>
                                    </div>
                                    <div class="content">
                                        <h6><a href="blog-details.html">1 Day Left For Your Premium Package To
                                                Expire.</a></h6>
                                        <span><img src="assets/images/icon/clock-1.svg" alt> 5 hour ago</span>
                                    </div>
                                </li>
                                <li>
                                    <div class="company-img">
                                        <img src="assets/images/bg/company-logo/recent-activity-03.png" alt>
                                    </div>
                                    <div class="content">
                                        <h6><a href="blog-details.html">Your Job Posted Published On Position
                                                WordPress.</a></h6>
                                        <span><img src="assets/images/icon/clock-1.svg" alt> 1 hour ago</span>
                                    </div>
                                </li>
                                <li>
                                    <div class="company-img">
                                        <img src="assets/images/bg/company-logo/recent-activity-04.png" alt>
                                    </div>
                                    <div class="content">
                                        <h6><a href="blog-details.html">Your Job Posted Published On Position Frontend
                                                Developer.</a></h6>
                                        <span><img src="assets/images/icon/clock-1.svg" alt> 1 hour ago</span>
                                    </div>
                                </li>
                        ...
                        <div class="swiper-slide">
                            <div class="feature-card2">
                                <div class="company-area">
                                    <span></span>
                                    <div class="logo">
                                        <img src="{{ asset('front_assets/images/bg/company-logo/company-02.png') }}"
                                            alt>
                                    </div>
                                        ...
                                        <div class="name-location">
                                            ...
                                            <ul>
                                                ...
                                                <li class="verified"><img
                                                        src="{{ asset('front_assets/images/icon/verified.svg') }}"
                                                        alt>
                                                    Verified Company</li>
                                            </ul>
                                        </div>
                                ...
                                <div class="job-discription">
                                    <ul class="one">
                                        ...
                                        <li>
                                            <p><span class="title">Salary:</span> $90-$140 / <span class="time">Per
                                                    Hour</span></p>
                                        </li>
                                    </ul>
                                    <ul>
                                        ...
                                        <li>
                                            <p><span class="title">Deadline:</span><span class="time"> 3 February,
                                                    2023</span></p>
                                        </li>
                                    </ul>
                                </div>
                        ...
                        <div class="swiper-slide">
                            <div class="feature-card2">
                                <div class="company-area">
                                    <span></span>
                                    <div class="logo">
                                        <img src="{{ asset('front_assets/images/bg/company-logo/company-03.png') }}"
                                            alt>
                                    </div>
                                    <div class="company-details">
                                        <div class="name-location">
                                ...
                                <div class="job-discription">
                                    <ul class="one">
                                        ...
                                        <li>
                                            <p><span class="title">Salary:</span> $80K-$110K / <span
                        ...
                        <div class="swiper-slide">
                            <div class="feature-card2">
                                <div class="company-area">
                                    <span></span>
                                    <div class="logo">
                                        <img src="{{ asset('front_assets/images/bg/company-logo/company-04.png') }}"
                                            alt>
                                    </div>
                                    <div class="company-details">
                                        <div class="name-location">
                                ...
                                <div class="job-discription">
                                    <ul class="one">
                                        ...
                                        <li>
                                            <p><span class="title">Salary:</span> $50K-$60K / <span
                                    ...
                                    <ul>
                                        ...
                                        <li>
                                            <p><span class="title">Deadline:</span><span class="time"> 4 February,
                                                    2023</span></p>
                                        </li>
                                    </ul>
                                </div>
                    ...
                    <div class="col-lg-6 d-flex  justify-content-lg-start justify-content-center">
                        <div class="copyright-area">
                            <p>©Copyright 2023 <a href="#">HireTop</a> | Design By <a
                                    href="https://ajspire.com/">Ajspire Technologies Pvt. Ltd.</a></p>
                        </div>
                    </div>
                    <div class="col-lg-6 d-flex justify-content-lg-end justify-content-center">
                        <div class="social-area">
