...
Route::get('/career-at-gc', [HomeController::class, 'careerAtGC']);
Route::post('/career-at-gc/store', [HomeController::class, 'storeCareerForm']);
Route::get('/job-provider', [HomeController::class, 'jobProvider']);
Route::post('/job-provider/store', [HomeController::class, 'storeJobProviderForm']);
Route::get('/job-seeker', [HomeController::class, 'jobSeeker']);
Route::post('/job-seeker/store', [HomeController::class, 'storeJobSeekerForm']);
